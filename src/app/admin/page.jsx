...
const PRODUCTS_DATA = [
  { emoji:'👟', brand:'Nike',    name:'Pegasus 40',    price:1899, stock:24, status:'Active',   tag:'Best Seller' },
  { emoji:'👟', brand:'ASICS',   name:'Gel-Kayano 30', price:2499, stock:12, status:'Active',   tag:'New' },
  { emoji:'👟', brand:'Brooks',  name:'Ghost 15',      price:1399, stock:3,  status:'Low Stock',tag:'Sale' },
  { emoji:'👟', brand:'Hoka',    name:'Clifton 9',     price:2299, stock:18, status:'Active',   tag:'New' },
  { emoji:'👟', brand:'Adidas',  name:'Ultraboost 23', price:2999, stock:0,  status:'Out of Stock',tag:'' },
]
