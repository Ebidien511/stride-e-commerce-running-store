    ...
    <>
      ...
      <section style={S.hero}>
        <div style={S.heroLeft}>
          ...
          <p style={S.heroSub}>Describe what you're looking for and our AI will find your perfect shoe.</p>

          {/* AI Search Prompt */}
          <div style={{ marginBottom: 40 }}>
            <div style={{ background: 'white', border: '2px solid var(--border)', borderRadius: 12, padding: '4px 4px 4px 20px', display: 'flex', alignItems: 'center', gap: 8, boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
            ...
            {aiError && <p style={{ fontSize: 12, color: 'var(--red)', marginTop: 8, fontWeight: 500 }}>{aiError}</p>}
            <p style={{ fontSize: 11, color: 'var(--mid)', marginTop: 10, fontFamily: 'DM Mono' }}>Try: "lightweight road shoe for marathons" · "stable trail shoe under R2500"</p>
          </div>
