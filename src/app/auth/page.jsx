        ...
        <div style={{width:'100%',maxWidth:420}}>
          ...
          {mode === 'signup' && (
            <div>
              ...
              <button onClick={handleSignUp} style={{width:'100%',background:'var(--black)',color:'white',border:'none',padding:15,borderRadius:10,fontSize:15,fontWeight:700,cursor:'pointer',marginTop:24,transition:'all 0.2s'}}
                onMouseEnter={e=>e.currentTarget.style.background='var(--accent)'}
                onMouseLeave={e=>e.currentTarget.style.background='var(--black)'}
